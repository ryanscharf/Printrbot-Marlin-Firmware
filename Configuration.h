...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 449.20
  #define DEFAULT_bedKi 88.44
  #define DEFAULT_bedKd 570.37
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 180                   // Y point for Z homing when homing all axes (G28).
#endif
